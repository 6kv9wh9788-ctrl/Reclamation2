...
| --- | --- | --- |
| Sustained escape/pursuit speed | 2.8 m/s | 3.3 m/s |
| Sprint/burst speed | 5.0 m/s | 5.2 m/s |
| Full burst duration | 4 simulation seconds | 2 simulation seconds |
| Recovery from empty | 12 simulation seconds | 10 simulation seconds |
| Automatic activation distance | 5 m from threat | 5 m from prey |
