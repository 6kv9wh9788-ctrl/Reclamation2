...
namespace Reclamation.Neighborhood
{
    ...
    public sealed class LabCameraController : MonoBehaviour
    {
        ...
        {
            followed = null; pivot = initialPivot; yaw = initialYaw; pitch = initialPitch;
        ...
        private void LateUpdate()
        {
            ...
            if (InputEnabled && !uiBusy && keyboard != null)
            {
                ...
                if (keyboard.escapeKey.wasPressedThisFrame) followed = null;
        ...
        private void OnGUI()
        {
            ...
            GUILayout.Label(followed != null ? $"Following: {followed.name}" : "Camera: free view", textStyle);
